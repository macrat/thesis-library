<template>
	<div>
		...
		<h2>誰がやってるの？</h2>
		2017年度卒業生の<a href="https://blanktar.jp">志太悠真</a>が勝手に運営しています。

		<h2>使い方は？</h2>
		左の一覧か<a href="/search" @click.prevent="$router.push({ path: '/search' })">検索ページ</a>から論文を探して、読むことが出来ます。<br>
		...
		あとサーバー代を払ってくれる人が出てくるととてもうれしいです。<br>
	</div>
</template>
